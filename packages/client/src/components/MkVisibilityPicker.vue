...
const props = withDefaults(defineProps<{
	currentVisibility: typeof speechka.noteVisibilities[number];
...
const emit = defineEmits<{
	(ev: 'changeVisibility', v: typeof speechka.noteVisibilities[number]): void;
...
function choose(visibility: typeof speechka.noteVisibilities[number]): void {
	v = visibility;
