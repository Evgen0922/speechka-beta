...
let appearNote = $computed(() => isRenote ? note.renote as speechka.entities.Note : note);
...
const conversation = ref<speechka.entities.Note[]>([]);
const replies = ref<speechka.entities.Note[]>([]);
