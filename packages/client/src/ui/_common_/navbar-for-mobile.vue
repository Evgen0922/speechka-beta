...
<div class="kmwsukvl">
	<div class="body">
		...
		<div class="middle">
			...
			<MkA v-if="$i.isModerator" v-click-anime class="item" active-class="active" to="/moderator">
				<i class="icon fas fa-door-open fa-fw"></i><span class="text">{{ i18n.ts.controlPanel }}</span>
			</MkA>
			<MkA v-if="$i.isAdmin" v-click-anime class="item" active-class="active" to="/admin">
				<i class="icon fas fa-door-open fa-fw"></i><span class="text">{{ i18n.ts.controlPanel }}</span>
			</MkA>
