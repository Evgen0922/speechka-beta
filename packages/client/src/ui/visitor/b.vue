	...
	<div class="main">
		...
		<div class="contents">
			...
			<div v-if="!root" class="powered-by">
				<b><MkA to="/">{{ host }}</MkA></b>
				<small>Powered by <a href="https://github.com/Evgen0922/speechka-dev" target="_blank">Speechka</a></small>
			</div>
		</div>
	</div>
